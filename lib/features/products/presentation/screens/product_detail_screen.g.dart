...
String _$productDetailHash() => r'cf0862a73ada89e671ec70ce73cff939071d6937';
...
class ProductDetailFamily extends Family<AsyncValue<ProductModel>> {
  ...
  /// See also [productDetail].
  ProductDetailProvider call(String shopId, String productId) {
    return ProductDetailProvider(shopId, productId);
  }
...
class ProductDetailProvider extends AutoDisposeFutureProvider<ProductModel> {
  /// See also [productDetail].
  ProductDetailProvider(String shopId, String productId)
    : this._internal(
        (ref) => productDetail(ref as ProductDetailRef, shopId, productId),
  ...
  bool operator ==(Object other) {
    return other is ProductDetailProvider &&
        other.shopId == shopId &&
...
class _ProductDetailProviderElement
  ...
  @override
  String get shopId => (origin as ProductDetailProvider).shopId;
  @override
