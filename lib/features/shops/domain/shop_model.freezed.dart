...
mixin _$ShopModel {
 ...
 String get id; String get name; String? get location; String? get phone; bool get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,location,phone,isActive);

@override
String toString() {
  return 'ShopModel(id: $id, name: $name, location: $location, phone: $phone, isActive: $isActive)';
}
...
@useResult
$Res call({
 String id, String name, String? location, String? phone, bool isActive
});
...
/// Create a copy of ShopModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? location = freezed,Object? phone = freezed,Object? isActive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? location,  String? phone,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShopModel() when $default != null:
return $default(_that.id,_that.name,_that.location,_that.phone,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? location,  String? phone,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _ShopModel():
return $default(_that.id,_that.name,_that.location,_that.phone,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? location,  String? phone,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _ShopModel() when $default != null:
return $default(_that.id,_that.name,_that.location,_that.phone,_that.isActive);case _:
  return null;
...
/// Create a copy of ShopModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? location = freezed,Object? phone = freezed,Object? isActive = null,}) {
